  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6 py-12">
      ...
      <p className="text-lg text-gray-600 text-center max-w-md mb-4">
        It looks like your payment didn&apost go through or was cancelled.
      </p>
      <p className="text-md text-gray-700 text-center max-w-md mb-6">
        If this was a mistake, don&apost worry — you can try again anytime to secure your spot at the event.
      </p>
